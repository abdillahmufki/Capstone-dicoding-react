    ...
    return (
        <div className="max-w-screen-xl p-6 bg-white border border-gray-200 rounded-base shadow dark:bg-gray-800 dark:border-gray-700 m-auto">
            ...
            <form id="mapForm" onSubmit={handleSubmit} className="max-w-screen-xl mx-auto mt-7">
                ...
                <div className="mb-5">
                    <label htmlFor="impact" className="block mb-2 text-base font-medium text-gray-900 dark:text-white">
                        Dampak yang ditimbulkan:
                    </label>
                    <input type="text" id="impact" name="impact" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Contoh : Bangunan mengalami retak, tembok retak, tanah ambles" />
                    <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">*Jika tidak merasakan boleh anda kosongkan saja.</p>
                </div>
                <div className="mb-5">
                    <label htmlFor="address" className="block mb-2 text-base font-medium text-gray-900 dark:text-white">
                        Alamat:
                    </label>
                    <input type="text" id="address" name="address" value={address} readOnly className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
                <button
                    type="submit"
