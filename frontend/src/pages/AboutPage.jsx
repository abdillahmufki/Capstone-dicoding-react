      ...
      <section className="bg-white pt-8 antialiased dark:bg-gray-900 md:py-16 mt-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div className="mx-auto max-w-5xl">
            <PageHeader
              pageName="About PusGO"
              pageDescription="We are dedicated to delivering accurate and timely information
            on earthquakes, as well as education that can help communities
            ...
            <div className="mx-auto max-w-2xl space-y-6">
              ...
              <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                platform edukasi dan informasi gempa bumi yang dibangun oleh
                tiga orang profesional untuk memberikan informasi yang akurat
                dan mudah dipahami.
              </p>
              ...
              <ul className="list-outside list-disc space-y-4 pl-4 text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                <li>
                  Memberikan informasi dan edukasi yang efektif dan efisien
                  untuk membantu masyarakat menghadapi gempa.
                </li>
                <li>
